    ...
    bLim = double(20/255);
     ...
     for i = 1:length(imgMask(:,1))
        for j = 1:length(imgMask(1,:))
            ...
            if (abs(R(i,j) - G(i,j)) > double(15/255) &&...
                    R(i,j) > B(i,j) &&...
                    R(i,j) > G(i,j) &&...
                    B(i,j) > bLim &&...
                    G(i,j) > double(40/255) &&...
                    R(i,j) > rLim &&...
                    Cr(i,j) >= (0.93*Cb(i,j))+double(16.21/255) &&...
                    Cr(i,j) <= (0.93*Cb(i,j))+double(93/255) &&...
                    Cr(i,j) <= (-0.94*Cb(i,j))+double(288.97/255) &&...
                    Cr(i,j) >= (-0.92*Cb(i,j))+ double(231/255) &&...
                    Cr(i,j) < double(178/255) &&...
                    Cr(i,j) > double(125/255) &&...
                    Cb(i,j) < double(140/255) &&...
                    Cb(i,j) > double(80/255))
