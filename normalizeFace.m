...
if eyeL(2) > eyeR(2)
    ...
    rotatedImage=rotateAround(inputImg, eyeR(2), eyeR(1), -degrees,'bicubic');
    ...
    %way.
    rotatedImage=rotateAround(inputImg, eyeL(2), eyeL(1), degrees,'bicubic');
...
outputImg = colorCorrection(outputImg);
end
